...
# def reshapes(fp1):
#     embed = tf.reshape(fp1, [1, 14, 14, 1])
#     return embed
...
def sam_vgg(data):
    ...
    #attention_conv_5 = Conv2D(1, (1, 1), activation='sigmoid', name='att_conv5', trainable=trainable)(jym_gol.get_value('fp0'))
    ...
    # conv_5_out: (1, 14, 14, 512)                  VGG第五层
    # s_conv_5_out: (1, 14, 14, 64)                 VGG输出结果
    # s_saliency_conv_5: (1, 14, 14, 1)             VGG输出结果可视化
    # attention_conv_5: (1, 14, 14, 1)              眼动图

    fp = attention_conv_5
    print('fp0, attention_conv_5: ' + str(fp))
    print('shape: ' + str(fp.shape))
    print('type: ' + str(type(fp)))
    fp1 = jym_gol.get_value('fp0')
    # fp1 = Conv2D(1, (1, 1), activation='sigmoid', name='att_conv5', trainable=trainable)(fp1)
    print('global_fp: ' + str(fp1))
    print('shape: ' + str(fp1.shape))
    print('type: ' + str(type(fp1)))
    print('-----------------------------------------------------------')

    attention_conv_5 = fp1
    ...
    print('s_saliency_conv_5: ' + str(fp1))
    print('shape: ' + str(fp1.shape))
    print('type: ' + str(type(fp1)))
    fp2 = saliency_conv_5
    print('saliency_conv_5: ' + str(fp2))
    print('shape: ' + str(fp2.shape))
    print('type: ' + str(type(fp2)))
    fp3 = saliency_conv_4
    print('saliency_conv_4: ' + str(fp3))
    print('shape: ' + str(fp3.shape))
    print('type: ' + str(type(fp3)))
    fp4 = saliency_conv_3
    print('saliency_conv_3: ' + str(fp4))
    print('shape: ' + str(fp4.shape))
    print('type: ' + str(type(fp4)))
    fp5 = saliency_conv_2
    print('saliency_conv_2: ' + str(fp5))
    print('shape: ' + str(fp5.shape))
    print('type: ' + str(type(fp5)))
    fp6 = saliency_conv_1
    print('saliency_conv_1: ' + str(fp6))
    print('shape: ' + str(fp6.shape))
    print('type: ' + str(type(fp6)))
    print('-----------------------------------------------------------')
